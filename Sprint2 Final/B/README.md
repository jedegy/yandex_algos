...
Еще её иногда называют постфиксной нотацией.<br>
...
Это значит, что округление всегда происходит вниз. А именно: если a / b = c, то b ⋅ c — это наибольшее число, которое не 
